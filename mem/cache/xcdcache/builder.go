...
// A Builder can build XCD caches
type Builder struct {
	engine              akita.Engine
	freq                akita.Freq
...
// Build creates a usable XCD cache.
func (b *Builder) Build(name string) *XCDCache {
	cache := new(XCDCache)
...
func (b *Builder) configureCache(cacheModule *XCDCache) {
...
func (b *Builder) createPorts(cache *XCDCache) {
...
func (b *Builder) createPortSenders(cache *XCDCache) {
...
func (b *Builder) createInternalStages(cache *XCDCache) {
...
func (b *Builder) createInternalBuffers(cache *XCDCache) {
