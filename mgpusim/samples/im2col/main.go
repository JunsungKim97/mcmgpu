...
import (
	...
	"gitlab.com/akita/mgpusim/benchmarks/dnn/im2col"
	"gitlab.com/akita/mgpusim/samples/runner"
)

var n = flag.Int("N", 1, "batch size")
var c = flag.Int("C", 1, "input channels")
var h = flag.Int("H", 4096, "input height")
var w = flag.Int("W", 4096, "input width")

// var h = flag.Int("H", 2048, "input height")
// var w = flag.Int("W", 2048, "input width")
...
func main() {
	...
	benchmark := im2col.NewBenchmark(runner.GPUDriver)
	benchmark.N = *n
	benchmark.C = *c
	benchmark.H = *h
	benchmark.W = *w
