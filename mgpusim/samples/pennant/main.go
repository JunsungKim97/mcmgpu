...
var zoneFlag = flag.Int("zones", 1048576, "Number of zones")
var pointFlag = flag.Int("points", 2097152, "Number of points")

// 10MB
// var zoneFlag = flag.Int("zones", 262144, "Number of zones")
// var pointFlag = flag.Int("points", 524288, "Number of points")
