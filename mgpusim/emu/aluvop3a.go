...
func (u *ALUImpl) runVOP3A(state InstEmuState) {
	...
	case 234: // V_CMP_EQ_U64
		u.runVCmpEqU64VOP3a(state)
	case 235: // V_CMP_LE_U64
		u.runVCmpLeU64VOP3a(state)
	case 236: // V_CMP_GT_U64
		u.runVCmpGtU64VOP3a(state)
	case 237: // V_CMP_LG_U64
		u.runVCmpLgU64VOP3a(state)
	case 238: //V_CMP_GE_U64
		u.runVCmpGeU64VOP3a(state)
	case 256:
...
func (u *ALUImpl) runVCmpClassF32VOP3a(state InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	sp.VCC = 0
	var i uint
	var src0 float32
...
func (u *ALUImpl) runVCmpGeU64VOP3a(state InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpEqU64VOP3a(state InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpLeU64VOP3a(state InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpGtU64VOP3a(state InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpLgU64VOP3a(state InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
