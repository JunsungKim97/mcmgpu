...
var NumNodes = flag.Int("numNodes", 8388608, "The number of rows in the input matrix.")
var NumItems = flag.Int("numItems", 16777216, "The number of rows in the input matrix.")
